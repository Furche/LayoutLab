...
**Last updated:** 2026-07-23 (Gizmo overlay clear `0.10.56`)
**Plugin / Core version:** 0.10.56 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.56.
...
- **`0.10.41`–`0.10.56`:** Viewer multi-room + gizmos; default furnished bedroom on boot
