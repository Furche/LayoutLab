...
**Last updated:** 2026-07-23 (Gizmo pick/hover `0.10.54`)
**Plugin / Core version:** 0.10.54 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.54.
...
- **`0.10.41`–`0.10.54`:** Viewer multi-room + gizmos; default furnished bedroom on boot
