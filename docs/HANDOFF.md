...
**Last updated:** 2026-07-23 (Bed scale axes `0.10.57`)
**Plugin / Core version:** 0.10.57 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.57.
...
- **`0.10.41`–`0.10.57`:** Viewer multi-room + gizmos; default furnished bedroom on boot
