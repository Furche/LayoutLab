...
**Last updated:** 2026-07-23 (Gizmo overlay `0.10.55`)
**Plugin / Core version:** 0.10.55 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.55.
...
- **`0.10.41`–`0.10.55`:** Viewer multi-room + gizmos; default furnished bedroom on boot
