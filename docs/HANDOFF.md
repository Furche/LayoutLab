...
**Last updated:** 2026-07-23 (Selection gizmo UX `0.10.51`)
**Plugin / Core version:** 0.10.51 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.51.
...
- **`0.10.41`–`0.10.51`:** Viewer multi-room + gizmos; default furnished bedroom on boot
