...
**Last updated:** 2026-07-23 (Flat 2D gizmos `0.10.53`)
**Plugin / Core version:** 0.10.53 · **Branch:** `main`
...
Branch: main. Core/plugin v0.10.53.
...
- **`0.10.41`–`0.10.53`:** Viewer multi-room + gizmos; default furnished bedroom on boot
