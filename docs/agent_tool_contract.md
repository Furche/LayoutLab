...
**Status:** Active (`agent_tools` 0.5 — DD-011/015/016/017 Accepted; candidates expand shipped; evaluation schema pending)  
...
16. Minimal DD-017 schema (profiles/roles/intentions, signed scores, veto) ← **next**  
