...
17. Core functional shortlist ✅ (`shortlist_ids`); bounded revision ✅ (`0.10.26`); **recipe force path** ✅ (`0.10.27`); **selection surfacing** ✅ (`0.10.28`); **user shortlist pick** ✅ (`0.10.29`, chat + Viewer); optional AI aesthetics (flag) ← **next** (aesthetics)  
