...
| [DD-014](DD-014-standalone-runtime-path.md) | Standalone runtime path (viewer → write adapter) | **Accepted — Phase A only** | 2026-07-17 |
...
path (Phase A Accepted; multi-space Spatial Project remains a later DD).
