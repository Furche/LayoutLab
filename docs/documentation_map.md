...
| [docs/Future_Ideas.md](Future_Ideas.md) | **Ideas backlog** — vision concepts before DD/architecture | PO, architect, team | Problem-first vision, accessibility, planning layers, **runtime independence (§11)**, bridge — **single file** | Vision sharpened; runtime note; idea promoted to DD | §11 Blender-independent runtime |
...
| Document | Purpose | Audience | Owns | Update when… | Typical changes |
|---|---|---|---|---|---|
| [docs/ARCHITECTURE.md](ARCHITECTURE.md) | As-built vs target: layers, modules, migration, **runtime coupling** | Implementers, architect | Module map, Core vs Blender Runtime (§2.2), layer boundaries, coupling inventory | Core/adapter documented; module split | §2.2 runtime inventory |
