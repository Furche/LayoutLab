...
| [docs/Future_Ideas.md](Future_Ideas.md) | **Ideas backlog** — vision concepts before DD/architecture | PO, architect, team | Problem-first vision, accessibility, planning layers, bridge, synthesis — **single file**, themed sections §1–10 | Vision sharpened; idea promoted to DD; section status changes | 2026-07-12 reorganize: Product Vision, Problem-first, Accessibility, … |
