...
const ADD_FURNITURE = {
  ...
  lamp_basic: { label: "Lamp", params: { base: 0.12, height: 0.38 } },
  floor_lamp_basic: { label: "Floor lamp", params: { base: 0.28, height: 1.55 } },
  keyboard_basic: { label: "Keyboard", params: { width: 0.45, depth: 0.15, height: 0.025 } },
  monitor_basic: { label: "Monitor", params: { width: 0.52, depth: 0.18, height: 0.42 } },
  laptop_basic: { label: "Laptop", params: { width: 0.32, depth: 0.22, height: 0.02 } },
  mouse_basic: { label: "Mouse", params: { width: 0.06, depth: 0.1, height: 0.035 } },
  tablet_basic: { label: "Tablet", params: { width: 0.18, depth: 0.26, height: 0.01 } },
  notepad_basic: { label: "Notepad", params: { width: 0.15, depth: 0.21, height: 0.015 } },
  book_basic: { label: "Books", params: { width: 0.16, depth: 0.12, height: 0.04, count: 2 } },
  mug_basic: { label: "Mug", params: { width: 0.08, depth: 0.08, height: 0.1 } },
  plant_basic: { label: "Plant", params: { pot: 0.14, height: 0.4 } },
  frame_basic: { label: "Picture frame", params: { width: 0.22, depth: 0.08, height: 0.3 } },
  speaker_basic: { label: "Speaker", params: { width: 0.12, depth: 0.14, height: 0.22 } },
  pillow_basic: { label: "Pillow", params: { width: 0.5, depth: 0.35, height: 0.12 } },
  blanket_basic: { label: "Blanket", params: { width: 1.2, depth: 0.8, height: 0.05 } },
  rug_basic: { label: "Rug", params: { width: 1.6, depth: 1.0, height: 0.012 } },
  doormat_basic: { label: "Doormat", params: { width: 0.6, depth: 0.4, height: 0.015 } },
  box_basic: { label: "Box", params: { width: 0.4, depth: 0.3, height: 0.3 } },
  laundry_basket_basic: {
    label: "Laundry basket",
    params: { width: 0.4, depth: 0.4, height: 0.5 },
  },
};
